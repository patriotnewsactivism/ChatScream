...
```ts
import { useCreateDemoUser, useListStreams, useCreateDonation, useGetMyDonationGoals } from '@dataconnect/generated/react';
...
const { data, isPending, isSuccess, isError, error } = useCreateDonation(createDonationVars);

const { data, isPending, isSuccess, isError, error } = useGetMyDonationGoals();
...
```js
import { createDemoUser, listStreams, createDonation, getMyDonationGoals } from '@dataconnect/generated';
