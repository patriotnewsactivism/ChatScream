  ...
  const handleGenerate = useCallback(async () => {
    ...
    try {
      ...
      const prompts: Record<ContentType, string> = {
        article: `You are Don Matthews, a fearless investigative journalist with We The People News. Write a hard-hitting article based on this livestream transcript. Include specific case law citations where relevant. Use a passionate, constitutional-rights-focused tone. Format with headline, byline (Don Matthews, We The People News), and body paragraphs.\n\nTranscript:\n${transcript.slice(0, 8000)}`,
        facebook: `Write a powerful Facebook post based on this livestream transcript. Keep it punchy, passionate, and focused on constitutional rights. Include relevant hashtags. This is for Don Matthews / We The People News.\n\nTranscript:\n${transcript.slice(0, 4000)}`,
