  ...
  return (
    <div className="flex flex-col h-full bg-dark-900 overflow-y-auto p-4 space-y-6">
      ...
      <div className="space-y-3">
        ...
        <div
          className={`space-y-3 transition-opacity ${settings.showLowerThird ? 'opacity-100' : 'opacity-50 pointer-events-none'}`}
        >
          <div>
      ...
      <div className="space-y-3">
        ...
        <div
          className={`transition-opacity ${settings.showTicker ? 'opacity-100' : 'opacity-50 pointer-events-none'}`}
        >
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <h3 className="text-xs font-bold text-gray-400 uppercase flex items-center gap-2">
            <Palette size={14} /> Logo Watermark
          </h3>
          <label className="relative inline-flex items-center cursor-pointer">
            <input
              type="checkbox"
        ...
        <div
          className={`space-y-3 transition-opacity ${settings.showLogo ? 'opacity-100' : 'opacity-50 pointer-events-none'}`}
        >
          <div>
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              ...
              <select
                ...
                className="w-full bg-dark-800 border border-gray-700 rounded p-2 text-xs text-white outline-none"
              >
            ...
            <div>
              ...
              <input
                ...
                className="w-full h-8 accent-brand-500"
              />
            </div>
          </div>
        </div>
